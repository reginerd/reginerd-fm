...
YOUTUBE_AUDIO_URL="${YOUTUBE_AUDIO_URL:-http://${RGNRD_ICECAST_HOST}:${RGNRD_ICECAST_PORT}${RGNRD_ICECAST_MOUNT}}"
...
echo "Relaying ${RGNRD_CALL_SIGN} ${RGNRD_ICECAST_MOUNT} -> YouTube RTMP"
